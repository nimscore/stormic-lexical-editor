...
export class InlineImageNode extends DecoratorNode {
    ...
    decorate() {
        return (React.createElement(InlineImageComponent, { src: this.__src, altText: this.__altText, width: this.__width, height: this.__height, nodeKey: this.getKey(), showCaption: this.__showCaption, caption: this.__caption, position: this.__position }));
    }
}
