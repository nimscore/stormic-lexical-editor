...
import { $getSelection, $isLineBreakNode, $isRangeSelection, CLICK_COMMAND, COMMAND_PRIORITY_CRITICAL, COMMAND_PRIORITY_HIGH, COMMAND_PRIORITY_LOW, getDOMSelection, KEY_ESCAPE_COMMAND, SELECTION_CHANGE_COMMAND, } from 'lexical';
...
function FloatingLinkEditor({ editor, isLink, setIsLink, anchorElem, isLinkEditMode, setIsLinkEditMode, }) {
    ...
    return (React.createElement("div", { ref: editorRef, className: "link-editor" }, !isLink ? null : isLinkEditMode ? (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", null,
            React.createElement("div", { className: "link-cancel", role: "button", tabIndex: 0, onMouseDown: preventDefault, onClick: () => {
                    setIsLinkEditMode(false);
                } }),
            React.createElement("div", { className: "link-confirm", role: "button", tabIndex: 0, onMouseDown: preventDefault, onClick: handleLinkSubmission })))) : (React.createElement("div", { className: "link-view" },
        React.createElement("a", { href: sanitizeUrl(linkUrl), target: "_blank", rel: "noopener noreferrer" }, linkUrl),
        React.createElement("div", { className: "link-edit", role: "button", tabIndex: 0, onMouseDown: preventDefault, onClick: (event) => {
                event.preventDefault();
                setEditedLinkUrl(linkUrl);
                setIsLinkEditMode(true);
            } }),
        React.createElement("div", { className: "link-trash", role: "button", tabIndex: 0, onMouseDown: preventDefault, onClick: () => {
...
function useFloatingLinkEditorToolbar(editor, anchorElem, isLinkEditMode, setIsLinkEditMode) {
    ...
    return createPortal(React.createElement(FloatingLinkEditor, { editor: activeEditor, isLink: isLink, anchorElem: anchorElem, setIsLink: setIsLink, isLinkEditMode: isLinkEditMode, setIsLinkEditMode: setIsLinkEditMode }), anchorElem);
}
