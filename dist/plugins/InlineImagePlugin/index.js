...
export function InsertInlineImageDialog({ activeEditor, onClose, }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Select, { style: { marginBottom: '1em', width: '290px' }, label: "Position", name: "position", id: "position-select", onChange: handlePositionChange },
        ...
        React.createElement(DialogActions, null,
            React.createElement(Button, { "data-test-id": "image-modal-file-upload-btn", disabled: isDisabled, onClick: () => handleOnClick() }, "Confirm"))));
}
