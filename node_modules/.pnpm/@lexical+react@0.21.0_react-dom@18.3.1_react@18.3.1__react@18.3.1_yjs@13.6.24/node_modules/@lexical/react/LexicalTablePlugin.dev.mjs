...
import { setScrollableTablesActive, TableNode, TableCellNode, TableRowNode, INSERT_TABLE_COMMAND, $createTableNodeWithDimensions, $computeTableMapSkipCellCheck, $createTableCellNode, $getTableAndElementByKey, $getNodeTriplet, $computeTableMap, $isTableRowNode, $isTableCellNode, getTableElement, applyTableHandlers } from '@lexical/table';
import { mergeRegister, $insertNodeToNearestRoot, $insertFirst } from '@lexical/utils';
import { $isTextNode, COMMAND_PRIORITY_EDITOR, $createParagraphNode } from 'lexical';
